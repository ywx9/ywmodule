...
$cmd = "&`"$cl`" ywlib.cpp /std:c++latest /EHsc /nologo /W4 /DYWLIB /Fe.output\ /Fo.output\ /reference ywlib=.module\ywlib.ifc /reference std=.module\std.ifc /link .module\std.obj /LIBPATH:`"$l0`" /LIBPATH:`"$l1`" /LIBPATH:`"$l2`""
